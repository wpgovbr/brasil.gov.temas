...
(function($){$("#dropmenu li > a ").on("click",function(e){var nodes=$(this).parent().find("ul").size();var current=$(this).parent().find("ul");if(nodes>0){$("ul.children").each(function(){if($(this).html()==current.html()){current.slideToggle();}else{$(this).hide();}});return false;}});$("h2.setor").click(function(){$(this).next("div.agenda").slideToggle();});})(Zepto);setTimeout(function(){window.scrollTo(0,1);},1000);